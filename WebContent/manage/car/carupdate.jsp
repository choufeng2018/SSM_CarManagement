...
<TABLE cellSpacing=0 cellPadding=0 width="80%" align=center border=1>
    ...
    <TD align="center"> 
    <input  type="text" name="chepai" value="${bean.chepai }"  id='chepaiid'  size="50"   />
    ...
    <TD align="center"> 
    <input  type="text" name="chejia" value="${bean.chejia }" id='chejiaid'  size="50"  />
    ...
    <TD align="center"> 
    <input  type="text" name="pinpai" value="${bean.pinpai }" id='pinpaiid'  size="50"  />
    ...
    <TD align="center"> 
    <input  type="text" name="xinghao" value="${bean.xinghao }" id='xinghaoid'  size="50"  />
   ...
   <img  src="<%=basePath %>${bean.pic }" width="200" height="200" />
    ...
    <TD align="center"> 
    <input  type="text" name="price" value="${bean.price }" id='priceid'  size="50"  />
    ...
    <TD align="center"> 
    <input  type="text" name="xsz" value="${bean.xsz }" id='xszid'  size="50"  />
    ...
    <TD align="center"> 
    <input  type="text" name="yanse" value="${bean.yanse }"  id='yanseid'  size="50"  />
    ...
    <TD align="center"> 
    <input  type="text" name="zujin" value="${bean.zujin }" id='zujinid'  size="50"  />
