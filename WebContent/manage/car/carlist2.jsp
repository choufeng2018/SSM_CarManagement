...
<TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=1>
    ...
    <TD align="center"> 
      ...
      <a href="${url2 }delete2.do?id=${bean.id }" onclick="return confirm('确定要维修吗?'); ">
      <span style="font-size: 12px;">维修</span></a>
      &nbsp;
 	  </c:if>
 	  
 	  <c:if test="${bean.status=='维修中'}">
      <a href="${url2 }delete3.do?id=${bean.id }" onclick="return confirm('确定要设置吗?'); ">
      <span style="font-size: 12px;">设置待租赁</span></a>
      &nbsp;
 	  </c:if>
