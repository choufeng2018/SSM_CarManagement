...
function checkfrom()
{
	...
	return true;
                      ...
                      <form name="form1" method="post" action="login2.do" onsubmit="return checkfrom()">
                        ...
                        <table width="98%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#529C33" style="border-collapse:collapse">
                          ...
                          <tr>
                            <td>&nbsp;</td>
                            <td>
                            <input type="submit" name="Submit5" value="登录"  style="width:80px; height:30px; border:solid 1px #000000; color:#666666"/>
                              &nbsp; &nbsp; &nbsp; &nbsp;
