...
border=0>
  ...
  <TR>
   ...
   <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">  
     ...
     <tr>
     <td width='11%'>留言时间：</td><td width='39%'>${bean.shijian1 }</td>
     <td width='11%'>回复时间：</td><td width='39%'>${bean.shijian2 }</td>
     </tr>
     
     
    <tr>
     <td width='11%' height="137">留言内容：</td>
     <td colspan="3">
     ...
     ${bean.neirong }
      ...
      <tr>
     <td width='11%' height="137">回复内容：</td>
     <td colspan="3">
