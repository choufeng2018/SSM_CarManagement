                ...
                <TD style="PADDING-TOP: 8px" vAlign=top height=185><TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
                    ...
                    <TR>
                     ...
                     <c:if test="${bean.level!=0 }"> 
                        ...
                        <table width="50%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#529C33" style="border-collapse:collapse">
                          <tr>
                            <td>用户名：</td>
                          ...
                          <tr>
                            <td>VIP等级：</td>
                           <td align="center" width="50%"> ${bean.level }
                           </td>
                          </tr>
                          
                          <tr>
                            <td>到期时间：</td>
                            <td align="center" width="50%">${bean.enddate }</td>
                          </tr>
