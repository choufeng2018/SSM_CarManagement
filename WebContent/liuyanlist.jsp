          ...
          <TD vAlign=top>
            ...
            background=qtimages/zjgdj_79.gif border=0>
             ...
             留言标题:<input name="ltitle"  type="text" value="${ltitle }"/> 
               ...
               &nbsp;&nbsp;&nbsp;
                <input type="button" name="Submit32" value="在线留言" onClick="javascript:location.href='liuyanadd.do';" style=" height:25px; border:solid 1px #000000; color:#666666">
                </form>
                    ...
                    <TR>
                      <TD style="PADDING-TOP: 8px" align=middle class=newsline><table width="98%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="#FA9090" style="border-collapse:collapse">
                        ...
                        <tr>
                          ...
                          <td >
                           <a href="liuyanview.do?id=${bean.id }" >查看详情</a>
      						&nbsp;&nbsp;&nbsp;
                          <a href="liuyandelete.do?id=${bean.id }" onclick="{if(confirm('确认删除?')){return true;}return false;}">删除</a>
